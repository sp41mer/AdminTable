...
$(document).ready(function(){
  $(".container").on('click','.category.active',function(e){
    ...
    $.post(getContentMethod,
        ...
        function (data) {
          ...
          else newThis.append("<div  class = \'answer active\' data-id="+$(this).parent().data('id')+"><span>Нет вопросов</span><button class = \'js__answer__button__add\'>Добавить</button>");
        }, "json");
  });
  ...
  $(".container").on('click','.js__answer__button__add',function(e){
    ...
    $(this).after("<table class = \'details\'><thead><td>Название</td><td>Текст</td><td>Ccылка на видео</td><td>Изображение</td></thead>" +
        "<tbody><tr><td contenteditable=\'true\' class = \'detail name\' data-parent = \'"+newThis.data('id')+"\'></td>" +
        "<td contenteditable=\'true\' class =\'detail text\' data-parent = \'"+newThis.data('id')+"\'></td>" +
        "<td contenteditable=\'true\' class =\'detail video\' data-parent = \'"+newThis.data('id')+"\'></td>" +
        "<td contenteditable=\'true\' class =\'detail image\' data-parent = \'"+newThis.data('id')+"\'></td></tr></tbody></table><button class=\'js__details__button__new__save\'>Сохранить</button><button class=\'js__details__button__new__cancel\'>Отмена</button>");
  });
